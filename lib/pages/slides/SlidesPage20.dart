...
class SlidesPage20 extends StatelessWidget {
  const SlidesPage20({Key key, @required this.progression}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SlideTypeTitle(
      ...
      child: CCTFileBuilder(
          ...
          builder: (context, flexDemo) => ThreePanelsLayer(side1: <Widget>[
                SlideListItem(
              ...
              ], side3: SlideDemoItem(child: FlexibleExpandedDemo()))),
