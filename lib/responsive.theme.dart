...
import 'package:vtah_flutter_intro/ui/responsive/ResponsiveBreakpointsLayout.dart';
...
class ResponsiveThemeWidget extends StatefulWidget {
  ...
  @override
  ResponsiveThemeWidgetState createState() => ResponsiveThemeWidgetState();

  static ResponsiveThemeWidgetState of(BuildContext context) {
    return (context.inheritFromWidgetOfExactType(_ResponsiveTheme)
            as _ResponsiveTheme)
        .data;
  }
}
